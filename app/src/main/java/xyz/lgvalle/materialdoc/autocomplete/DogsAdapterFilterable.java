 ...
 */
public class DogsAdapterFilterable extends RecyclerView.Adapter<DogsAdapterFilterable.DogsViewHolder> implements Filterable {

    private final LayoutInflater layoutInflater;
    private String[] dogs = {"Schanutzer", "Collie", "Dogo", "Labrador"};
    List<String> filteredDogs;

    public DogsAdapterFilterable(Context context) {
    ...
    private class DogsFilter extends Filter {
        ...
        DogsAdapterFilterable adapter;
        String[] originalList;
        List<String> filteredList;

        public DogsFilter(DogsAdapterFilterable adapter, String[] originalList) {
            super();
